def specs():
    return [
        ...
        },
        {
            ...
            "description": "Get status of a background process started by this MCP server.",
            "inputSchema": {
                "type": "object",
        ...
        {
            "name": "stop_process",
            "description": "Stop a background process started by this MCP server.",
            "inputSchema": {
                "type": "object",
                "properties": {"process_id": {"type": "string"}},
                "required": ["process_id"],
...
def router(server):
    return {
        ...
        "get_process_status": server.get_process_status,
